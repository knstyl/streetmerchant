...
## [3.10.0](https://github.com/knstyl/streetmerchant/compare/v3.9.0...v3.10.0) (2025-01-14)
...
* **discord:** dynamic currency symbol ([#1328](https://github.com/knstyl/streetmerchant/issues/1328)) ([cccfde2](https://github.com/knstyl/streetmerchant/commit/cccfde245affc11506c69d1ef6c30c09953307d4))
...
* **lookup:** handle Cloudflare DDoS protection ([#1434](https://github.com/knstyl/streetmerchant/issues/1434)) ([f86a825](https://github.com/knstyl/streetmerchant/commit/f86a8259f37f0ed25b00e243b29aa28c3e68bdff)), closes [#1297](https://github.com/knstyl/streetmerchant/issues/1297)
...
* **playstation:** add queuing selector ([#1173](https://github.com/knstyl/streetmerchant/issues/1173)) ([67b19a7](https://github.com/knstyl/streetmerchant/commit/67b19a7a8b3dead5f5ab9575ee2b4f09924ce851))
...
* **store:** add globaldata ([#2004](https://github.com/knstyl/streetmerchant/issues/2004)) ([5effbae](https://github.com/knstyl/streetmerchant/commit/5effbae882bed9d287f8ccc84e9dd38a6ebdebb1))
...
* **store:** add Irish store variants ([#1373](https://github.com/knstyl/streetmerchant/issues/1373)) ([f70998f](https://github.com/knstyl/streetmerchant/commit/f70998f0d9a6cdfbc59fb31fecb87f801b0b3037))
...
* **store:** add several Australian stores, add some 3080 brands/models ([#1367](https://github.com/knstyl/streetmerchant/issues/1367)) ([579cb97](https://github.com/knstyl/streetmerchant/commit/579cb97a0d151cc374a37493b043ba4a399b55db))
...
* use node 15, use package version ([#2066](https://github.com/knstyl/streetmerchant/issues/2066)) ([eee669b](https://github.com/knstyl/streetmerchant/commit/eee669b1b3e54ada1180877fe766aaded9e02936))
...
* `.env` backwards compatibility ([9b7c7e2](https://github.com/knstyl/streetmerchant/commit/9b7c7e2881d756909af191094bda435ca7ef7e9b))
...
* **adblock:** proxy another function to produce less errors ([#1379](https://github.com/knstyl/streetmerchant/issues/1379)) ([eb70076](https://github.com/knstyl/streetmerchant/commit/eb700762a4eee3a802bd81f0fb62e76243027c42))
...
* **amazon-nl:** inStock selector ([b6964b0](https://github.com/knstyl/streetmerchant/commit/b6964b02f38c947fd476d86de35d5983e5b229dd)), closes [#1366](https://github.com/knstyl/streetmerchant/issues/1366)
...
* **bestbuy-ca:** update selectors to help false positives ([#1278](https://github.com/knstyl/streetmerchant/issues/1278)) ([0525119](https://github.com/knstyl/streetmerchant/commit/0525119b9bae47425a6c01720d6a1ea6ab8e6a02)), closes [#895](https://github.com/knstyl/streetmerchant/issues/895)
...
* clear cookies when rotating proxies ([#2575](https://github.com/knstyl/streetmerchant/issues/2575)) ([8854ce9](https://github.com/knstyl/streetmerchant/commit/8854ce97bba7858dfc9385530e0c090200944ede))
* compile errors ([ace655c](https://github.com/knstyl/streetmerchant/commit/ace655c3068871694b71f4553c1ea963114b190d))
...
* **config:** disable docker by default ([dca916b](https://github.com/knstyl/streetmerchant/commit/dca916b64e9ac2d05d5e6af19e5466b8a0623ed5))
* **config:** remove quotes ([ef452d8](https://github.com/knstyl/streetmerchant/commit/ef452d8e586536a5039ee532d655d2951d551ac3))
...
* **discord:** notification groupings ([ad0b2fe](https://github.com/knstyl/streetmerchant/commit/ad0b2fe525d6403735ddcbf4ef55b91eb36ac10a))
...
* **docker:** run in docker, and build scripts for docker ([#1291](https://github.com/knstyl/streetmerchant/issues/1291)) ([c74ea28](https://github.com/knstyl/streetmerchant/commit/c74ea28014ee0d827ea216083844f92e30f142c9))
...
* **newegg:** dedupe nitro+ models ([#1300](https://github.com/knstyl/streetmerchant/issues/1300)) ([7329c6e](https://github.com/knstyl/streetmerchant/commit/7329c6ede0a5ab6d644b30ac878f4e7da11e43a8)), closes [#1230](https://github.com/knstyl/streetmerchant/issues/1230)
...
* **newegg:** price selector and mobile inStock ([c3beedc](https://github.com/knstyl/streetmerchant/commit/c3beedced82141e6bbb0735b3edb7c573907aa7a)), closes [#1356](https://github.com/knstyl/streetmerchant/issues/1356)
...
* parsing prices with thousands separator and European format ([#2153](https://github.com/knstyl/streetmerchant/issues/2153)) ([61f8e3a](https://github.com/knstyl/streetmerchant/commit/61f8e3a9a03136682035881fce6d14356717d1ac))
...
* **store:** update UK stores ([#1372](https://github.com/knstyl/streetmerchant/issues/1372)) ([02825d0](https://github.com/knstyl/streetmerchant/commit/02825d009bd028f6dcdca02e2c155e77a7df8654))
...
* **wipoid:** corrected 3070 / 3080 links ([#1879](https://github.com/knstyl/streetmerchant/issues/1879)) ([2572c8a](https://github.com/knstyl/streetmerchant/commit/2572c8af80685be514ff762f8203e7de7cab8634))
...
* add 5080 and 5090 ([3d5d89c](https://github.com/knstyl/streetmerchant/commit/3d5d89cc94338b43faae5905ad7d518f961720e4))
...
* add pokemon tcg ([ceca0e8](https://github.com/knstyl/streetmerchant/commit/ceca0e8c0d12533254a303cd0d2f36159944cfa4))
...
* bump dependencies ([#2413](https://github.com/knstyl/streetmerchant/issues/2413)) ([3c00eca](https://github.com/knstyl/streetmerchant/commit/3c00eca22378afb2a18aa76c1d4204107e6364c2))
...
* deployment manifest ([06b71ae](https://github.com/knstyl/streetmerchant/commit/06b71ae4111cdf95af17ce0b15444e7bd6b48fb7))
...
* **deps-dev:** bump @types/node from 14.14.10 to 14.14.12 ([#1340](https://github.com/knstyl/streetmerchant/issues/1340)) ([b6ea0ea](https://github.com/knstyl/streetmerchant/commit/b6ea0ea991adee5d37c84f995f566df44781f31f))
...
* **deps-dev:** bump @types/node from 14.14.35 to 14.14.36 ([#2233](https://github.com/knstyl/streetmerchant/issues/2233)) ([a7a5e69](https://github.com/knstyl/streetmerchant/commit/a7a5e6954b3568b40d360982d5f11287c1b7f440))
...
* **deps-dev:** bump @types/puppeteer from 5.4.1 to 5.4.2 ([#1289](https://github.com/knstyl/streetmerchant/issues/1289)) ([d92d58d](https://github.com/knstyl/streetmerchant/commit/d92d58d23520f236f67548a004b4b554462b48f3))
...
* **deps-dev:** bump webpack from 5.22.0 to 5.23.0 ([#1993](https://github.com/knstyl/streetmerchant/issues/1993)) ([b6030b3](https://github.com/knstyl/streetmerchant/commit/b6030b3cc3bdd4011b4bd5eba1789ce4224e8896))
...
* **deps:** bump actions/setup-node from v2.1.2 to v2.1.3 ([#1338](https://github.com/knstyl/streetmerchant/issues/1338)) ([0683430](https://github.com/knstyl/streetmerchant/commit/068343076887b35dc041df1fa149bef7f29185f3))
...
* **deps:** bump dependencies ([1ab0af2](https://github.com/knstyl/streetmerchant/commit/1ab0af234ca76b5db8602ffe04a1fc80b3c6515b))
...
* **deps:** bump GoogleCloudPlatform/release-please-action from v2.10 to v2.12.2 ([#1339](https://github.com/knstyl/streetmerchant/issues/1339)) ([769f19e](https://github.com/knstyl/streetmerchant/commit/769f19efa2a73b24d4a81f400e8c696eb6424df5))
...
* **deps:** bump open from 8.0.2 to 8.0.3 ([#2186](https://github.com/knstyl/streetmerchant/issues/2186)) ([54883f0](https://github.com/knstyl/streetmerchant/commit/54883f0ad7cf86052035d88ed2ffbc612c439725))
...
* **deps:** bump twilio from 3.53.0 to 3.54.0 ([#1287](https://github.com/knstyl/streetmerchant/issues/1287)) ([7bfcc81](https://github.com/knstyl/streetmerchant/commit/7bfcc81fdcd788434d853f511d0697878b551e28))
...
* **deps:** bump twitch-auth from 4.4.5 to 4.4.7 ([#1855](https://github.com/knstyl/streetmerchant/issues/1855)) ([233c449](https://github.com/knstyl/streetmerchant/commit/233c4496e2e763498c414130d00285feebf958a7))
* **deps:** bump twitch-chat-client from 4.3.5 to 4.3.6 ([#1308](https://github.com/knstyl/streetmerchant/issues/1308)) ([37962f0](https://github.com/knstyl/streetmerchant/commit/37962f00e5a88f5f185b79c34902d6cf4ecec936))
...
* fix dotenv ([432a238](https://github.com/knstyl/streetmerchant/commit/432a23833e34793b37f710871c7a76021d04f01a))
* fix env ([56e9d5e](https://github.com/knstyl/streetmerchant/commit/56e9d5ef96b3732c8ae91ba1e62cb0f26fe7ab71))
* fix namespace ([4cf195d](https://github.com/knstyl/streetmerchant/commit/4cf195d91a8a86c35c368068ec770d532d61c052))
...
* int fix ([85a8db3](https://github.com/knstyl/streetmerchant/commit/85a8db3f79373447ebf2e9cc66ea6ff9558192dc))
...
* **main:** release 3.9.0 ([#3165](https://github.com/knstyl/streetmerchant/issues/3165)) ([cca68ba](https://github.com/knstyl/streetmerchant/commit/cca68ba9b7392127e9643dd80c46c1f2ba3c4f80))
* manifest update ([8369320](https://github.com/knstyl/streetmerchant/commit/8369320ed64064a0fe6b3df67e49d36bc0dc2f4d))
...
* pokemon tcg and 5000 changes ([05287bc](https://github.com/knstyl/streetmerchant/commit/05287bc94b2470838ee26b35386962117e7bc329))
...
* release 3.3.0 ([#1233](https://github.com/knstyl/streetmerchant/issues/1233)) ([b97d581](https://github.com/knstyl/streetmerchant/commit/b97d58160792b80cf07ee2358e1532bdacf2a683))
* release 3.4.0 ([#1391](https://github.com/knstyl/streetmerchant/issues/1391)) ([f474cc6](https://github.com/knstyl/streetmerchant/commit/f474cc69664396fbde9bfd88aba4ad977f872e07))
...
* remove test ([d817db7](https://github.com/knstyl/streetmerchant/commit/d817db79820c6d514fdc7e34df8955bc493e33d9))
...
* resolve newegg ([6ce7702](https://github.com/knstyl/streetmerchant/commit/6ce7702c1b4d9dc2ae4480c81abe2e52d6c96204))
...
* update logos ([2a5e2e8](https://github.com/knstyl/streetmerchant/commit/2a5e2e873362000ab8c5cdef2c57b6fdb3574ec9))
* update manifest file ([f6ce633](https://github.com/knstyl/streetmerchant/commit/f6ce633161207940ae4b323900df035c00d6b47c))
* update package-lock, remove ci perms ([#3059](https://github.com/knstyl/streetmerchant/issues/3059)) ([ba98f26](https://github.com/knstyl/streetmerchant/commit/ba98f2653ea865cc0c08687b05277566cfc1db32))
* update pr template ([f0e5c5d](https://github.com/knstyl/streetmerchant/commit/f0e5c5d17bad282480da30cc68e5bd8eb9d80844))
* update stale workflow ([e4a267f](https://github.com/knstyl/streetmerchant/commit/e4a267f675800b04d06ddb4212de1373a767a113))
* update template, typos in docs ([#1386](https://github.com/knstyl/streetmerchant/issues/1386)) ([d592cd5](https://github.com/knstyl/streetmerchant/commit/d592cd5d77452363188e69aeaa94e57417f48135))
* **walmart:** update 5900x url ([#2184](https://github.com/knstyl/streetmerchant/issues/2184)) ([b2ce715](https://github.com/knstyl/streetmerchant/commit/b2ce7157d9631d6edd45debcb9ab85bc79241133))
* **xbox:** update oos selector ([4d89306](https://github.com/knstyl/streetmerchant/commit/4d8930616d2296fcdd6c0d79bac2109f1388a0b0)), closes [#2118](https://github.com/knstyl/streetmerchant/issues/2118) [#2479](https://github.com/knstyl/streetmerchant/issues/2479) [#2475](https://github.com/knstyl/streetmerchant/issues/2475) [#2200](https://github.com/knstyl/streetmerchant/issues/2200)


### Continuous Integration

* add workflow_dispatch for quick releases ([064ce83](https://github.com/knstyl/streetmerchant/commit/064ce83f03c736d1baf6c55da6e5d1edfa380f24))
* bump node-version ([40c4a8c](https://github.com/knstyl/streetmerchant/commit/40c4a8c1b9e50cf94f7a595aa78a4802d2fa981d))
* change check-date name ([812dc5e](https://github.com/knstyl/streetmerchant/commit/812dc5ea8d9830c251a526c02de05a15bfe20602))
* change pr linter ([1c113ef](https://github.com/knstyl/streetmerchant/commit/1c113efc423de994456411e04485eec414aaef78))
* checkout when publish ([a5c0ed8](https://github.com/knstyl/streetmerchant/commit/a5c0ed8d9f22169649d700c1d7d02b18cdf658d6))
* don't need to run on main ([#2792](https://github.com/knstyl/streetmerchant/issues/2792)) ([4da5200](https://github.com/knstyl/streetmerchant/commit/4da5200b5a6e85e11d96f320f658e8f5f9a0a70c))
* fix cache ([e1b4320](https://github.com/knstyl/streetmerchant/commit/e1b43206fcf037c140e507bb4d08c72248d76dcc))
* fix checkout and names ([6c2ca19](https://github.com/knstyl/streetmerchant/commit/6c2ca198b6d5b114e8146c1e15fe87324aec4f8f))
* fix docker release ([c2a2271](https://github.com/knstyl/streetmerchant/commit/c2a22716cce0de6cbdbfdf7ebdceb97844a22e0f))
* fix documentation ([ebf8b20](https://github.com/knstyl/streetmerchant/commit/ebf8b20071dc628b1f47b96ee2b03f888c056dd9))
* fix if statement ([560e614](https://github.com/knstyl/streetmerchant/commit/560e61414a6a5ea3856f34905a470bdbc262d135))
* fix needs output ref ([305e8f0](https://github.com/knstyl/streetmerchant/commit/305e8f0fb237306705a481266ecedf841f57192a))
* fix needs ref ([557cde4](https://github.com/knstyl/streetmerchant/commit/557cde46367576e9ca6a9e207f3bc80be630b960))
* fix nightly ([52b5e5e](https://github.com/knstyl/streetmerchant/commit/52b5e5e79ac381b585ec1dd63288aefe4f9da9d1))
* fix nightly release ([5f81a8a](https://github.com/knstyl/streetmerchant/commit/5f81a8a25f60788d1c529078aab89675d6b5ffc3))
* fix permissions and steps ([5551f78](https://github.com/knstyl/streetmerchant/commit/5551f78365971829137eb2a062de08996b7c7bdf))
* fix pr lint trigger ([9e8c836](https://github.com/knstyl/streetmerchant/commit/9e8c83622d130c4adfc90e7388b7d79f380800fa))
* fix release-please ([7997d6d](https://github.com/knstyl/streetmerchant/commit/7997d6d22a6a3469adeef798d6bf5b66fb055101))
* fix tags ([e67a383](https://github.com/knstyl/streetmerchant/commit/e67a3838e195b0e6c3039546f6e48d30e291fd6a))
* give tag an output ([36771fd](https://github.com/knstyl/streetmerchant/commit/36771fd55539c17b7fb589b2e5811644e62916fa))
* pin version to major ([2c3c47b](https://github.com/knstyl/streetmerchant/commit/2c3c47b4a92a25513c2a7f3fdf5fb02a7857de1f))
* quote tags ([9ce7dac](https://github.com/knstyl/streetmerchant/commit/9ce7dac951552d239c83e56bebadbfa22ae02110))
* remove fetch-depth ([c21d412](https://github.com/knstyl/streetmerchant/commit/c21d412ed5959bd7a0a56a6dcf624ff9e6c2dac8))
* replace runs with run ([9ec2018](https://github.com/knstyl/streetmerchant/commit/9ec2018d58438897cb7ed01157433536171754ae))
* rerun pr lint if synced ([659edcd](https://github.com/knstyl/streetmerchant/commit/659edcd421c97abe650ddd3d61fbd345f2727fee))
* revert username ([2d702b3](https://github.com/knstyl/streetmerchant/commit/2d702b32b4ea370d27071f4ffa833c3c0ac8cc88))
* run ci on main ([e8ee59f](https://github.com/knstyl/streetmerchant/commit/e8ee59fae16b08deaf3d83549c9a803fe97a582c))
* test code check ([#3058](https://github.com/knstyl/streetmerchant/issues/3058)) ([245ade7](https://github.com/knstyl/streetmerchant/commit/245ade7e15625cefa5862c9708fdefcce1bd9df3))
* update changelog-types ([0a8334a](https://github.com/knstyl/streetmerchant/commit/0a8334aa440e3e6acfbb9cfe392c72af36a391bf))
* update names and steps ([#1720](https://github.com/knstyl/streetmerchant/issues/1720)) ([8ece4b6](https://github.com/knstyl/streetmerchant/commit/8ece4b641229d16fd7d453e3f7cca40e8dde4373))
* update naming ([5d3ca2e](https://github.com/knstyl/streetmerchant/commit/5d3ca2ead9e93384436948b9ef60d377b2bccf34))
* update pr lint ([e527e43](https://github.com/knstyl/streetmerchant/commit/e527e43e85034df6e2852d61fb7909e6f1949763))
* update pr lint secret ([7cf60f8](https://github.com/knstyl/streetmerchant/commit/7cf60f84e1ca1c87ec7c6ba6ae24c89af31097ce))
* update pr linter ([25d556c](https://github.com/knstyl/streetmerchant/commit/25d556c736a90b64f4312e4a4332dbc922b71f66))
* update release-please ([704fa39](https://github.com/knstyl/streetmerchant/commit/704fa393c2bd22809b0eb7b12a05e82afe6bd090))
* update stale labels ([b412146](https://github.com/knstyl/streetmerchant/commit/b4121463ed7f25566cfa4ff508fa0c4d03237a9d))
* update verbiage for steps ([#1721](https://github.com/knstyl/streetmerchant/issues/1721)) ([05720e5](https://github.com/knstyl/streetmerchant/commit/05720e519bd0482ddb7c96bb954832e4e5e02973))
* use github actor ([cf83753](https://github.com/knstyl/streetmerchant/commit/cf83753853344a328379f0b3f101a26957254096))
* use github token ([27dc9d2](https://github.com/knstyl/streetmerchant/commit/27dc9d220ccc9ea98976ec271c526d72c8724b9a))
* use single quotes ([bfc5bfd](https://github.com/knstyl/streetmerchant/commit/bfc5bfd29f0034e99a7d2f006cd480401c0cfd35))


### Documentation

* add better heroku documentation ([#2942](https://github.com/knstyl/streetmerchant/issues/2942)) ([f344615](https://github.com/knstyl/streetmerchant/commit/f344615c34254f9da937cffb84d95bb7fce4c0ee))
* add documentation for RESTART_TIME ([1009ce6](https://github.com/knstyl/streetmerchant/commit/1009ce6636c21c378121bd83b251a371a1b8568e))
* add hyperlinks ([ca2580d](https://github.com/knstyl/streetmerchant/commit/ca2580d72b8f232d4630bd7dc666d0d8314b7e54))
* add information around 3060 ([#2031](https://github.com/knstyl/streetmerchant/issues/2031)) ([69e0059](https://github.com/knstyl/streetmerchant/commit/69e005905ae38e6cd1fe37d7588b472556cf164d))
* add missing `font` key ([0c80d6c](https://github.com/knstyl/streetmerchant/commit/0c80d6caeae03c0bb2a7db0d80e49129ce9b53d6))
* add terraform reference ([fbb024a](https://github.com/knstyl/streetmerchant/commit/fbb024a9cefa34e3291c060c39951b4cc66760d5))
* add terraform to mkdocs ([488bc54](https://github.com/knstyl/streetmerchant/commit/488bc544c98c3f69013f02ba77cae414cc516faf)), closes [#1987](https://github.com/knstyl/streetmerchant/issues/1987)
* change 3090 to 4090 ([dccaa52](https://github.com/knstyl/streetmerchant/commit/dccaa52ce99125740fcfdf3c9a71bdf261574097))
* change fonts to Roboto ([272b49b](https://github.com/knstyl/streetmerchant/commit/272b49b4ac10f1c3d92ae748679bd6a184893164))
* **discord:** add xbox* groups ([0d75025](https://github.com/knstyl/streetmerchant/commit/0d75025cbb2cad2577954eebf20a6e6c46e6cb6b)), closes [#1352](https://github.com/knstyl/streetmerchant/issues/1352)
* **filter:** update El Corte Inglés location ([#1369](https://github.com/knstyl/streetmerchant/issues/1369)) ([db47827](https://github.com/knstyl/streetmerchant/commit/db47827e6e70e0a0e02a8f4ed30ef8c3372bcb96))
* fix badge ([bb01bed](https://github.com/knstyl/streetmerchant/commit/bb01bedb037d4230c85a7fe59ce40ef7e29ea5a1))
* fix badge link ([9d5af9f](https://github.com/knstyl/streetmerchant/commit/9d5af9f8f9cda7e12fb19575be4b7805c65a77cd))
* fix banner location ([a9b2ecf](https://github.com/knstyl/streetmerchant/commit/a9b2ecfd48fed0c33302dc10e97658c726940a52))
* fix hotlink ([8db16dd](https://github.com/knstyl/streetmerchant/commit/8db16dd0cb64c1da5a42a2b5b2a1696926a3e599))
* fix sort-able tables ([08789a7](https://github.com/knstyl/streetmerchant/commit/08789a70c4b9e76000f881edda35acd07bdd60b9))
* fix spelling in "Creating a Discord webhook" ([#1646](https://github.com/knstyl/streetmerchant/issues/1646)) ([943ab83](https://github.com/knstyl/streetmerchant/commit/943ab837e2e4dd55700a6a7c204a0871647fcfaa))
* include max prices for adding a store ([7e3020a](https://github.com/knstyl/streetmerchant/commit/7e3020a927edbe9381e4a75df29b5bb8aeaffcc7))
* make templates required ([00b468a](https://github.com/knstyl/streetmerchant/commit/00b468a73832b959e0c6ac1ed67b0b23856db76b))
* medimax is de store ([5786481](https://github.com/knstyl/streetmerchant/commit/5786481b31e4d354fffc0af4eea3117907056394))
* **reference:** add AMD 6800, 6800xt, 6900xt ([#1463](https://github.com/knstyl/streetmerchant/issues/1463)) ([70b2e7c](https://github.com/knstyl/streetmerchant/commit/70b2e7c4084fd63e268d29374a6f2f4226f0a6e0))
* **reference:** add AWD-IT ([#1460](https://github.com/knstyl/streetmerchant/issues/1460)) ([673b5f3](https://github.com/knstyl/streetmerchant/commit/673b5f325c10cf30feed9b166a2b93980db38d34))
* remove badges ([4388e9a](https://github.com/knstyl/streetmerchant/commit/4388e9a5e0cb1d1e544b5614fdba37efc2475d52))
* remove twitter ([d19d05c](https://github.com/knstyl/streetmerchant/commit/d19d05c2e5d4e6e20085116177e4320f74ddfe54))
* remove twitter ([1aa0224](https://github.com/knstyl/streetmerchant/commit/1aa0224da0718a8058996511f73c672938a231fb))
* **store:** add missing uk store ([#1384](https://github.com/knstyl/streetmerchant/issues/1384)) ([2d25c46](https://github.com/knstyl/streetmerchant/commit/2d25c464f88802194d81dd5c5639d821c0f67583))
* toggle light/dark mode ([1e76d5a](https://github.com/knstyl/streetmerchant/commit/1e76d5a270e7fb678ccea3649b38f323b346d702))
* **twitch:** add instructions on how to get tokens ([9c35e72](https://github.com/knstyl/streetmerchant/commit/9c35e728ac450838878b73394acbe12bfd34d55c))
* update badge ([42808b8](https://github.com/knstyl/streetmerchant/commit/42808b836cd8c9d0fc19f81dbceaab825f864d36))
* update badges ([82cafc4](https://github.com/knstyl/streetmerchant/commit/82cafc4135bb94abddfb8677703a9306010e0db3))
* update badges ([c2c8531](https://github.com/knstyl/streetmerchant/commit/c2c8531ea26e2b75f50ed384f5128e5df54053e9))
* update badges ([0730689](https://github.com/knstyl/streetmerchant/commit/07306891d7e2f286ac957841e6ddf6d654c2820e))
* update docker-compose information ([da78362](https://github.com/knstyl/streetmerchant/commit/da78362045bde23717d2c389ea18f14119a41d6c))
* update docker-compose title ([e2bf574](https://github.com/knstyl/streetmerchant/commit/e2bf5749c1936ac71797fcd8a27f0bf2e31df653))
* update edit_uri location ([af603c2](https://github.com/knstyl/streetmerchant/commit/af603c20aed49e01fc6923b1be1759a74575c12f))
* update incorrect store description for alternate-de ([#2765](https://github.com/knstyl/streetmerchant/issues/2765)) ([28ce7e9](https://github.com/knstyl/streetmerchant/commit/28ce7e995b6ea521f03ed5845387aa3858a34f72))
* update issue templates ([74d71e4](https://github.com/knstyl/streetmerchant/commit/74d71e457956743566796404458bd1d5d84598db))
* update issue templates ([9aa3f16](https://github.com/knstyl/streetmerchant/commit/9aa3f164a59cd521701f55bfe4a54872b1c5fc4d))
* update issue templates ([7171113](https://github.com/knstyl/streetmerchant/commit/71711131ff4c57abe3016e543b7d0ce994e0ecd0))
* update mkdocs appearance ([38630d4](https://github.com/knstyl/streetmerchant/commit/38630d478a4d66a984d9317379a53b522a21a8f7))
* update node references ([f65aab8](https://github.com/knstyl/streetmerchant/commit/f65aab87dade27c9f271ca816f83fe5a57ff7da6))
* update Xbox Series S and X price limit desc ([#2098](https://github.com/knstyl/streetmerchant/issues/2098)) ([ba35706](https://github.com/knstyl/streetmerchant/commit/ba35706cca84a425da8d5a5bd6b86dbecbadffa1))
* use main branch for badge ([8dab4bb](https://github.com/knstyl/streetmerchant/commit/8dab4bb1e3441493a809c603b078c69777fbd8ff))
* use node lts ([2a482e3](https://github.com/knstyl/streetmerchant/commit/2a482e3dfaaeaa2f285b98d32d67d44bdd4ef6f4)), closes [#2776](https://github.com/knstyl/streetmerchant/issues/2776)


### Refactoring

* **captcha:** use seconds instead of ms ([#2424](https://github.com/knstyl/streetmerchant/issues/2424)) ([d652b49](https://github.com/knstyl/streetmerchant/commit/d652b4936435377d36268141a2b63c8798f7f95b))
* change `.env` to be `dotenv` ([#1341](https://github.com/knstyl/streetmerchant/issues/1341)) ([9b3906c](https://github.com/knstyl/streetmerchant/commit/9b3906ca0046cc3c1fa977bf1b406b224d675bba))
* **freemobile:** remove local throw ([bf8f242](https://github.com/knstyl/streetmerchant/commit/bf8f242f4b33796fcee91a863f0e086fcec29537))
* make link labels &gt; store labels ([f583029](https://github.com/knstyl/streetmerchant/commit/f583029bf31e6bcec8b535a1fe088fa464771183))
* **materiel:** update docs, change name ([7ec8a16](https://github.com/knstyl/streetmerchant/commit/7ec8a160cf9844df34578fe9f413b88d6141178c))
* simplify maxPrice logic ([a25b7f1](https://github.com/knstyl/streetmerchant/commit/a25b7f19cc8e403ffd7856e631cde7e9df63f1cc))
* **store:** replace euroFormat with regex ([#2131](https://github.com/knstyl/streetmerchant/issues/2131)) ([795c723](https://github.com/knstyl/streetmerchant/commit/795c7230ad4632c81b17f5c2aeb3b0e88b2b04e3))
* use gts instead of xo ([f87053c](https://github.com/knstyl/streetmerchant/commit/f87053cb02e04b3cb2c0cf253187a9e9857c9858))
